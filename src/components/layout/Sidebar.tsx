import { CarFront, LayoutDashboard, Settings, LogOut, Wrench, X } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside 
        className={`fixed md:sticky top-0 left-0 h-screen w-64 bg-white dark:bg-[#111827] border-r border-slate-200 dark:border-slate-800 flex-shrink-0 flex flex-col transition-transform duration-300 z-50 shadow-2xl md:shadow-none
      ...
      >
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-black/20">
          <div className="flex items-center gap-3 px-3 py-3 mb-2 rounded-xl bg-white dark:bg-[#1f2937] border border-slate-200 dark:border-slate-700 shadow-sm">
            <div className="h-9 w-9 rounded-full bg-gradient-to-tr from-purple-500 to-primary-600 flex items-center justify-center text-xs font-bold text-white uppercase border-2 border-white dark:border-slate-800 shrink-0">
